...
class TransferService:
    def __init__(self):
        # Memory State
        self.active_uploads: Dict[str, Dict[str, str]] = defaultdict(
            dict
        )  # client_id -> {final_path: upload_id}
        self.active_downloads: Dict[str, Dict[str, Dict]] = defaultdict(
            dict
        )  # client_id -> {download_id: session}
